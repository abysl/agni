...
- Added a bounded hardened-Wasm host/joiner regression: Mirror Image copies Covert Informant's public face, printed Might, token identity, and Empower script, then a joining replica reconstructs all of them from the host log.
